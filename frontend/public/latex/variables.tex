...
\def\personalTitle{Software Developer}
\def\summary{Dynamic, agile software full-stack software developer with rapid adaptability to emerging technologies, a keen aptitude for grasping intricate concepts and solving problems with automation and data science.}
\def\languages{Python, SQL, JavaScript, TypeScript, C++, C, HTML, CSS}
\def\technologies{ReactJS, NodeJS, Git, Alteryx, SQL Server, MySQL, Numpy/Pandas/Selenium, Excel}
\def\courses{Databases, UI, Networks, Algorithms}
\def\links{
    {
        {Globe}
        {roman-hudaj.com}
        {https://github.com/rhudaj}
    },
    {
        {Github}
        {github.com/rhudaj}
    ...
    },
    {
        {Envelope}
        {rhudaj@uwaterloo.ca}
        {mailto:rhudaj@uwaterloo.ca}
    },
    {
        {Linkedin}
        {/in/rhudaj}
        {https://www.linkedin.com/rhudaj}
    }
}
\def\experiences{
    {
